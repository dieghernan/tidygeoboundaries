...
> Note: This is a simple illustration. See the package vignettes for full
> details on parameters, filters, caching, and advanced usage.
...
This package is released under the CC BY-4.0 license. See the `LICENSE.md` file
for full details. Note that the boundary data being accessed (via geoBoundaries)
also uses open licences; please check the specific dataset metadata for
licensing details.
