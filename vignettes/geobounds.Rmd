...
current
#> [1] "C:\\Users\\RUNNER~1\\AppData\\Local\\Temp\\RtmpoRTr4H"

# Change to new
newdir <- file.path(tempdir(), "/geoboundvignette")
geobn_set_cache_dir(newdir)
#> ✔ geobounds cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpoRTr4H//geoboundvignette'.
...
#> → Cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpoRTr4H//geoboundvignette/gbOpen'

# Restore cache dir
geobn_set_cache_dir(current)
#> ✔ geobounds cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpoRTr4H'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
